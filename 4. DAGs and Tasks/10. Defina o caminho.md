...
Tudo bem, há uma última coisa que você precisa saber.
 ...
 Então, digite de fluxo de ar, modelos de ponto, operador de base de ponto, cadeia de importação.
...
Agora a dependência cruzada está definida.
 ...
 Temos que importar cross downstream, então como chain ali mesmo, coloque cross underscore downstream, salve o arquivo.
 ...
 Se você clicar nele, receberá esta mensagem, tipos não suportados [inaudível 00:09:29] para lista e lista, o que significa que você não pode criar dependência entre duas listas de tarefas.
